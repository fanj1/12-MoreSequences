...
def run_test_draw_points_on_circle():
    ...
    # Test 4:
    title = 'DRAW_POINTS_ON_CIRCLE, test 4:  30 red dots.'
    window = rg.RoseWindow(500, 500, title)
    circle = rg.Circle(rg.Point(300, 300), 130)
    draw_points_on_circle(window, circle, 30, 'red')
    window.close_on_mouse_click()
...
def run_test_pizza():
    ...
    # Test 1:
    title = 'PIZZA test 4:  100 slices, thin (thickness=1) blue lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 1
    circle.fill_color = 'red'
    pizza(window, circle, 100, 'blue', 1)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    # Tests 3:
    title = 'POLYGON tests 3:  5 segments with thin green lines.'
    window = rg.RoseWindow(550, 400, title)

    circle = rg.Circle(rg.Point(100, 100), 80)
    circle.outline_thickness = 3
    polygon(window, circle, 5, 'green', 2)
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  100 lime green lines on blue circle, hops = 40.'
    window = rg.RoseWindow(500, 500, title)

    circle = rg.Circle(rg.Point(250, 250), 200)
    circle.fill_color = 'blue'
    fancy_polygon(window, circle, 100, 40, 'lime green', 2)
    window.close_on_mouse_click()
